...
-- This function computes the analysis for all possible subsets of properties.
-- All the possible subsets are generated by making use of subsequences.
-- computeAnalysis is then applid to each subset.
